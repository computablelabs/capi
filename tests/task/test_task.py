...
def test_get_pending_task(mock_get_task, test_client, cloudwatch_client):
...
@patch('apis.task.tasks.TaskRoute.get_task')
def test_get_successful_task(mock_get_task, test_client, cloudwatch_client):
...
@patch('apis.task.tasks.TaskRoute.get_task')
def test_get_failed_task(mock_get_task, test_client, cloudwatch_client):
...
@patch('apis.task.tasks.TaskRoute.get_task')
def test_get_non_existant_task(mock_get_task, test_client, cloudwatch_client):
...
def test_post_new_task(mock_start_task, test_client, cloudwatch_client):
