...
def get_send_data_hash_after_mining():
    """
    A sort of curry for the application context, define and return the async task here
    so that when it executes in the worker current_app and g are defined via closure
    TODO: assure that we arent creating crazy memory overhead doing this...
    """
