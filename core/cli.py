...
@click.option(
    '--gas_price', type=int, default=2,
    help='An int, representing GWEI, that will be set as gas_price for this transaction')
...
@click.option(
    '--hash', type=str,
    help='The Keccak hash which identifies the candidate to be resolved')
@click.option(
    '--gas_price', type=int, default=2,
    help='An int, representing GWEI, that will be set as gas_price for this transaction')
